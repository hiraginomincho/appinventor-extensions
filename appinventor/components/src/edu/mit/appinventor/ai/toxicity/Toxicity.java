...
package edu.mit.appinventor.ai.toxicity;
...
public final class Toxicity extends AndroidNonvisibleComponent implements Component {
  ...
  // other error codes are defined in toxicity.js
  ...
  public Toxicity(final Form form) {
    ...
    Log.d(LOG_TAG, "Created Toxicity component");
  }
  ...
  private void configureWebView(WebView webview) {
    ...
    webview.addJavascriptInterface(new JsObject(), "Toxicity");
    ...
    Runnable next = new Runnable() {
        public void run() {
          if (webviewer != null) {
            ...
            webview.loadUrl("https://hiraginomincho.github.io/toxicity/");
          }
        }
      };
