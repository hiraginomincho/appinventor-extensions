...
public final class SpeechCommands extends AndroidNonvisibleComponent implements Component {
  ...
  public SpeechCommands(final Form form) {
    ...
    Log.d(LOG_TAG, "Created SpeechCommands component");
  }
  ...
  private void configureWebView(WebView webview) {
    ...
    webview.addJavascriptInterface(new JsObject(), "SpeechCommands");
  ...
  public void StartListening() {
    assertWebView("StartListening");
    webview.evaluateJavascript("startListening();", null);
  }

  @SimpleFunction(description = "")
  public void StopListening() {
    assertWebView("StopListening");
